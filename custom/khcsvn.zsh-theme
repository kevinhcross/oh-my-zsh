...
function svn_prompt_info {
    ...
    if [ -d ".svn" ]; then
        ...
        # I don't need svn_repository and this line does not work with the version I use
        ...
        # show the results
        echo " on %{$fg[blue]%}$svn_branch @ $svn_version%{$reset_color%}%{$fg[yellow]%}$svn_change%{$reset_color%}"
...
RPROMPT='${return_status}$(date)$(git_prompt_status)%{$reset_color%}'
